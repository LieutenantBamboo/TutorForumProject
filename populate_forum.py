...
def populate():
	...
	math_questions=[
	 ...
	 "text field":"I'm blanking on my simple rules here whats the derivative of 1/x... i think its 1 but i could be completely wrong here if you can whats the derivative of f(x)= k/x and x/k where k is a constant ","views":10,"upvotes":14,"downvotes":2},
	 {"title": "How to Integrate [1/(x^2 + 1)] dx?","text_field":". Thanks in advance","views":3,"upvotes":1,"downvotes":1},]
 
 
	Physics_questions=[{"title": "Momentum ","text_field":"Can you please remind me the proof of the formula for momentum? i am stack","views":14,"upvotes":13,"downvotes":2},]
 
	Computer_questions=[{"title": "WAD2 assesed 2 ","text_field":"When is the deadline for assesed 2? Thanks","views":20,"upvotes":1,"downvotes":12},]
